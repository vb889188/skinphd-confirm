...
export function createSeed(): WorkspaceState {
  return {
    ...
    people: [
      { id: "person-amelia", branchId: "branch-brooklyn", fullName: "Amelia Naidoo", email: "amelia@pilot.local", role: "manager", status: "active", pinHash: "898ef9927844ff735a94e9c23a044607b805b87e7c59c21218be0294a54403c8", createdAt: now },
